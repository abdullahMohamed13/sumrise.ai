...
export default function Chatbot() {
  ...
  return (
    <Card className="flex h-[600px] flex-col pt-0 w-full border shadow-md rounded-lg">
      {/* Header */}
      ...
      <form onSubmit={handleSubmit} className="border-t p-3 space-y-2">
        <Textarea
          ...
          placeholder="Type smth, let's make it better yo..."
          disabled={isLoading}
        />
        <div className="flex justify-end gap-1.5 items-center">
          ...
          {/* Action buttons */}
            <Button size="sm" className="text-white" type="submit" disabled={!inputValue.trim() || isLoading}>
              Send
            </Button>
            <Button
              size="sm"
